...
provider_data_definitions() {   
    ...
    add_provider_record "7413|2404:7a84::/30| |biglobe_mape|BIGLOBE|map-e|download internet-map-e.sh chmod load; internet_map_main"
    add_provider_record "4713|2400:4150::/30| |ocn|OCN Virtual Connect|map-e|download internet-map-e.sh chmod load; internet_map_main"
    add_provider_record "2519|2409:10::/28| |transix_dslite|transix|ds-lite|download internet-ds-lite-config.sh chmod load; internet_dslite_main"
    add_provider_record "2527|2001:f70::/29| |cross_dslite|Cross Pass|ds-lite|download internet-ds-lite-config.sh chmod load; internet_dslite_main"
    add_provider_record "4737|2405:6580::/29| |v6connect_dslite|v6 Connect|ds-lite|download internet-ds-lite-config.sh chmod load; internet_dslite_main"
    add_provider_record " |2409:250::/28|gw.transix.jp|transix_generic_dslite|transix|ds-lite|download internet-ds-lite-config.sh chmod load; internet_dslite_main"
    ...
    add_provider_record "2515|240d:f::/32| |nuro|NURO Hikari|map-e|download internet-map-e.sh chmod load; internet_map_nuro_main"
