...
## **⚠️ ChatGPT への最優先ルール**  
**🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴**  
🚨 **ChatGPT は、必ずソース上の `"""""""""" """""""""""""""""` 内の要件を厳守すること。**  
🚨 **もし要件と実装が矛盾する場合、必ずユーザーに確認すること。**  
🚨 **要件に従わず、独自の判断で修正を加えてはならない。**  
🚨 **すべての変更・追加は、要件定義に基づき、ユーザーの承認を得ること。**  
🚨 **要件定義に変更が必要な場合は、まずユーザーに提案し、承認を得ること。**  
🚨 **不明点がある場合、推測せずに必ずユーザーに確認すること。**  
🚨 **以上のルールを最優先で遵守すること。**  
**🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴 🔴**  
