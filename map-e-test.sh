...
SCRIPT_VERSION="2025.04.05-00-14"
...
EOF
        ...
        IP6PREFIXLEN=38
        PSIDLEN=6
        # JavaScript では offset を変更していないため、コメントに変更
        # OFFSET=6 
        debug_log "DEBUG" "Calculated IPADDR=$IPADDR, IP6PREFIXLEN=$IP6PREFIXLEN, PSIDLEN=$PSIDLEN, OFFSET=$OFFSET"
    ...
    debug_log "DEBUG" "PSID=$PSID for PSIDLEN=$PSIDLEN"
    ...
    debug_log "DEBUG" "Calculated port range string: $PORTS"
